  ...
  return (
    <div className="navbar-container">
      ...
      <div className="navigation-area">
        <NavLink style={navLinksActive} className="links" to="/admin">
          <FaShoppingCart />
          <Typography>Table Status</Typography>
        </NavLink>
        <NavLink style={navLinksActive} className="links" to="/admin/orders">
          <FaShoppingCart />
        ...
        <NavLink
          ...
          className="links"
          to="/admin/mobile-orders"
        >
          <FaShoppingCart />
          <Typography>Online Orders</Typography>
        </NavLink>
        <NavLink style={navLinksActive} className="links" to="/admin/menu">
          <MdRestaurantMenu />
        ...
        <NavLink
          style={navLinksActive}
          className="links"
          to="/admin/process-bill"
        >
          <MdPrint />
          <Typography>Billing</Typography>
        </NavLink>
        <NavLink style={navLinksActive} className="links" to="/admin/reports">
          <MdPrint />
